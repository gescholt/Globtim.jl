...
if globtim_loaded
    ...
    try
        ...
        println("   Mean value: $(@sprintf("%.4f", sum(sample_values) / length(sample_values)))")
...
if globtim_loaded
    ...
    println("   Status: ⚠️  PARTIAL SUCCESS - Basic functionality works, Globtim needs attention")
end
