...
df_cheb, df_min_cheb = analyze_critical_points(f, df_cheb, TR, tol_dist=0.035)
df_lege, df_min_lege = analyze_critical_points(f, df_lege, TR, tol_dist=0.035)
...
save("gaussian_chebyshev_d_24.pdf", fig5)
save("gaussian_legendre_d_24.pdf", fig6)
