# ================================================================================
# 4D Deuflhard Critical Point Analysis - MSOLVE Version
# ================================================================================
# 
# PURPOSE:
...
# 
# KEY DIFFERENCE: Uses msolve instead of HomotopyContinuation.jl for polynomial solving
# 
...
# 3) POLYNOMIAL APPROXIMATION: Use Globtim with msolve to find 4D critical points numerically  
...
# MSOLVE SPECIFIC PARAMETERS
const MSOLVE_THREADS = 10                     # Number of threads for msolve
const MSOLVE_VERBOSE = false                  # msolve debug output
...
# EXECUTION START
# ================================================================================
println("=== 4D Deuflhard Critical Point Analysis (MSOLVE) ===\n")
...
# ================================================================================
# STEP 3: 4D POLYNOMIAL APPROXIMATION SETUP - MSOLVE VERSION
# ================================================================================
# Purpose: Configure and execute polynomial approximation for 4D composite function
# Uses msolve instead of HomotopyContinuation.jl for polynomial solving
...
# ================================================================================
# STEP 4: MSOLVE POLYNOMIAL SOLVING
# ================================================================================
# Purpose: Use msolve to solve the polynomial system instead of HomotopyContinuation.jl

println("\n=== Phase 2: Polynomial System Solving with msolve ===")

# Define polynomial variables
@polyvar(x[1:4])

# Use msolve workflow for solving and parsing
println("Solving 4D polynomial system with msolve...")
println("  • Polynomial degree: $POLYNOMIAL_DEGREE")
println("  • Threads: $MSOLVE_THREADS")
println("  • Basis: :chebyshev")

# Solve and parse using msolve
df_polynomial_4d = solve_and_parse(pol_4d, x, deuflhard_4d_composite, TR_4d;
                                  basis=:chebyshev,
                                  threads=MSOLVE_THREADS,
                                  verbose=MSOLVE_VERBOSE,
...
println("\n=== Phase 3: BFGS Refinement and Enhanced Analysis ===")
...
if nrow(df_final_minimizers_4d) > 0 && nrow(predicted_minima_4d) > 0
    println("\n=== SUMMARY TABLE: Final 4D Local Minimizers (MSOLVE + BFGS Refinement) ===")
    ...
    println("\n=== ANALYSIS SUMMARY (MSOLVE Version) ===")
    println("  • Solver: msolve (Gröbner basis method)")
    println("  • Threads used: $MSOLVE_THREADS")
...
println("\n=== ANALYSIS COMPLETE (MSOLVE Version) ===")