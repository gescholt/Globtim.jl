...
This script generates realistic test data using globtimcore's Deuflhard_4d function.
...
Output location:
    /Users/ghscholt/GlobalOptim/globtimpostprocessing/test/fixtures/
"""
...
summary = Dict(
    ...
    "generated_at" => Dates.format(now(), "yyyy-mm-ddTHH:MM:SS"),
    "generator_script" => "globtimcore/test/fixtures/generate_postprocessing_fixtures.jl"
)
