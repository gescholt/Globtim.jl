...
export test_input, ApproxPoly,
    ...
    bivariate_gaussian_noise, tref, tref_3d, Ackley, camel_3, camel, shubert,
    ...
    subdivide_domain, solve_and_parse, analyze_critical_points, plot_talk, load_function_params, FunctionParameters, analyze_degrees, analyze_converged_points
...
function __init__()
    ...
    @require CairoMakie = "13f3f980-e62b-5c42-98c6-ff1f3baf88f0" begin
        ...
        export plot_convergence_analysis, capture_histogram, create_legend_figure, plot_discrete_l2, plot_convergence_captured, plot_filtered_y_distances, cairo_plot_polyapprox_levelset, plot_distance_statistics
    end
