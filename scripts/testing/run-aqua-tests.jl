...
# Setup environment - activate main project to load Globtim
println("ℹ️  Activating main project environment (globtimcore)...")
Pkg.activate(".")
println("📦 Installing dependencies...")
Pkg.instantiate()

# Ensure Aqua is available (add temporarily if not in Project.toml)
println("📦 Checking for Aqua.jl...")
try
    import Aqua
