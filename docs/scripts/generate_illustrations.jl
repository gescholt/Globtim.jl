...
function generate_hero_step1()
    ...
    outpath = joinpath(OUTPUT_DIR, "hero_step1_sample.png")
    save(outpath, fig)
...
function generate_hero_step2()
    ...
    outpath = joinpath(OUTPUT_DIR, "hero_step2_polynomial.png")
    save(outpath, fig)
...
function generate_hero_step3()
    ...
    outpath = joinpath(OUTPUT_DIR, "hero_step3_minima.png")
    save(outpath, fig)
