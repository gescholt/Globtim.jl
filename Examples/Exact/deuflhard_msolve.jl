...
fig_1 = plot_matlab_comparison(df_merge_cheb, pol_cheb, TR, chebyshev_levels=true, num_levels=100)
fig_2 = plot_matlab_comparison(df_merge_lege, pol_lege, TR, chebyshev_levels=true, num_levels=60)
