...
echo
echo "🔗 Links:"
echo "  Milestone: https://git.mpi-cbg.de/scholten/globtim/-/milestones/$CURRENT_MILESTONE_ID"
echo "  Issues: https://git.mpi-cbg.de/scholten/globtim/-/issues?milestone_title=Sprint+2025-01"
echo "  Board: https://git.mpi-cbg.de/scholten/globtim/-/boards"
